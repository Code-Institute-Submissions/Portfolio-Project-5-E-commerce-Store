...
class OrderItem(models.Model):
    ...
    orderitem_total = models.DecimalField(max_digits=8, decimal_places=2, null=False, blank=False, editable=False)
    ...
    def __str__(self):
        return 'Order Item # ' + str(self.order.order_number) + ' with ' + str(self.product.name)
